...
while ($row = mysqli_fetch_assoc($result_select_query)) {
    ...
    <div class='card h-100' style='width: 18rem;'>
      ...
      <div class='card-body'>
        ...
        <a href='#' class='fun btn btn-secondary col-4 mb-2'>add to cart</a>
        <a href='#' class='fun btn btn-secondary col-4 mb-2'> add to wishlist</a>
        <a href='#' class='fun btn btn-secondary col-4'>buy</a>
        <a href='#' class='fun btn btn-secondary col-4'>details</a>
      </div>
    </div>
    </div>";
}
...
while ($row = mysqli_fetch_assoc($result_select_query)) {
    ...
    <div class='card h-100' style='width: 18rem;'>
      ...
      <div class='card-body'>
        <h5 class='card-title'>$product_title</h5>
        <p class='card-text'>$product_description</p>
        <a href='#' class='btn btn-secondary col-4 mb-2'>add to cart</a>
        <a href='#' class='btn btn-secondary col-4 mb-2'> add to wishlist</a>
